...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['user:read', 'cours:read', 'messages:read', 'vaultSheet:read', 'teacher:read','student:read'])]
    private ?int $id = null;
    ...
    #[Groups(['user:read', 'student:read', 'teacher:read'])]
    ...
    #[Groups(['teacher:read', 'student:read'])]
